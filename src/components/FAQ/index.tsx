            ...
            <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
              <div>
                ...
                <div className="mb-10">
                  ...
                  <p className="text-gray-500 ">
                    Feel free to{' '}
                    <a href="#" className="font-medium underline text-primary-600 " target="_blank" rel="noreferrer">
                      contact us
                    </a>{' '}
                ...
                <div className="mb-10">
                  ...
                  <p className="text-gray-500 ">
                    You can use Windster for an unlimited amount of projects, whether it's a personal website, a SaaS
                  ...
                  <p className="text-gray-500 ">
                    ...
                    <a href="#" className="font-medium underline text-primary-600 ">
                      reading the license
                    </a>
                    .
                  </p>
              ...
              <div>
                ...
                <div className="mb-10">
                  ...
                  <p className="text-gray-500 ">
                    Although both Windster and Tailwind UI are built for integration with Tailwind CSS, the main
                    difference is in the design, the pages, the extra components and UI elements that Windster includes.
                  </p>
                  <p className="text-gray-500 ">
                ...
                <div className="mb-10">
                  ...
                  <p className="text-gray-500 ">
                    Generally, it is accepted to use Windster in open-source projects, as long as it is not a UI
                    library, a theme, a template, a page-builder that would be considered as an alternative to Windster
                    itself.
                  </p>
                  <p className="text-gray-500 ">
